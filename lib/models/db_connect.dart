...
// declare the name of the table you want to create and add .json as suffix
  ...
  Future<List<Questionnaire>> fetchQuestions() async {
    ...
    return http.get(url).then((response) {
      ...
      List<Questionnaire> newQuestions = [];
      data.forEach((key, value) {
        var newQuestion = Questionnaire(
          qid: key, // the encrypted key/the title we gave to our data
